              ...
              <table class="my-4 w-full divide-gray-300 text-center table table-bordered table-hover">
                <thead class="bg-gray-50">
                  <tr>
                    ...
                    <th class="px-7 py-3 text-xs text-gray-700">USERNAME</th>
                    <th class="px-7 py-3 text-xs text-gray-700">FOTO</th>
                    <th class="px-7 py-3 text-xs text-gray-700">EMAIL</th>
                    <th class="px-7 py-3 text-xs text-gray-700">NAMA DEPAN</th>
                    <th class="px-7 py-3 text-xs text-gray-700">NAMA BELAKANG</th>
                    <th class="px-7 py-3 text-xs text-gray-700">ROLE</th>
                ...
                <tbody class="bg-white divide-y divide-gray-300">
                  ...
                  ?>
                    <tr class="whitespace-nowrap">
                      ...
                      <td class="px-7 py-3">
                        <div class="text-sm text-gray-900">
                          <img src="<?php echo base_url('image/karyawan/' . $row->image) ?>" width="50px" height="40px">
                        </div>
                      </td>
                      <td class="px-7 py-3">
                        <div class="text-sm text-gray-900">
