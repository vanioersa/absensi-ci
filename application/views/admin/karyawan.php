  ...
  <div class="d-flex">
    ...
    <div style="width:100%;">
      <div class="text-center m-4">
        <h1><b>
            <font color="white">Karyawan</font>
          </b></h1>
      </div>
        ...
        <tbody classs="table-grup-divider">
          ...
          foreach ($absensi as $row) : $no++ ?>
            <tr>
              ...
              <!-- <td>
                <a href="<?php echo base_url('admin/ubah_karyawan/') ?>" class="btn btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
      ...
      swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
          swalWithBootstrapButtons.fire(
            ...
            .then(function() {
              window.location.href = "<?php echo base_url('admin/delete_admin/') ?>" + id;
            })
        } else if (
