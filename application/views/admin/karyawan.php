  ...
  <div class="d-flex">
    ...
    <nav class="navbar navbar-expand-lg navbar bg-dark" data-bs-theme="dark" style="height: 50px; width: 1160px">
      ...
      <div class="py-3 h-auto " style="margin-left: 1px;">
        <h1 style="background-color: red; margin-bottom: 20px; text-align: center;"><b>Karyawan</b></h1>
        <!-- <form style="margin-left: 74%" method="post" enctype="multipart/form-data" action="<?= base_url('admin/import') ?>">
