    ...
    <div class="d-flex">
        ...
        <div class="container">
            <div class="text-center mt-5">
                <h1 style="font-size: 24px; background-color: #3498db; color: white; padding: 10px; border-radius: 5px;"><b>Rekap Mingguan</b></h1>
            </div>
            ...
            document.getElementById("exportButton").addEventListener("click", function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = '<?php echo base_url('admin/export_mingguan'); ?>';
                    }
                });
            });
        </script>
