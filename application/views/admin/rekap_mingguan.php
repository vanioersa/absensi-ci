    ...
    <section class="home-section">
        <div class="container">
            <div class="text-center mt-5">
                <h1 style="font-size: 24px; background-color: #000; color: white; padding: 10px; border-radius: 5px;"><b>Rekap Mingguan</b></h1>
            </div>
            <hr style="background-color: red; height: 10px;">
            <p><button id="exportButton" class="btn btn-dark"> Export <i class="fas fa-file-download"></i></button></p>
        ...
        document.getElementById("exportButton").addEventListener("click", function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = '<?php echo base_url('admin/export_minggu'); ?>';
                }
            });
        });
    </script>
