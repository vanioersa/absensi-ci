    ...
    <div class="d-flex">
        ...
        <div style="width:100%;">
            <div class="text-center m-4">
                <h1><b>
                        <font color="white">Rekap Bulanan</font>
                    </b></h1>
            </div>
            <hr size="10px" color="red">
            <br>
            <form style="margin-left: 73%;" action="<?php echo base_url('admin/rekap_bulanan') ?>" method="post">
            <select name="bulan" id="form-select" aria-label="Default Select excampel">
                <option selected>Bulan</option>'
                <option value="01">Muharram</option>
                <option value="02">Shafar</option>
                <option value="03">Rabiul Awal</option>
                <option value="04">Rabiul Akhir</option>
                <option value="05">Jumadil Awal</option>
                <option value="06">Jumadil Akhir</option>
                <option value="07">Rajab</option>
                <option value="08">Syakban</option>
                <option value="09">Ramadhan</option>
                <option value="10">Syawal</option>
                <option value="11">Dzulkaidah</option>
