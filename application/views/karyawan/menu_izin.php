    ...
    <div style="width: 50%; margin-left: 5%; margin-top: 3%;">
      <div class="card text-bg-secondary">
        <div class="card-body">
          ...
          <p class="card-text"><input style="width: 80%;margin-left: 20px;" type="text"></p>
          <a href="profile" style="margin-left: 20px; margin-bottom: 50px;" class="btn btn-primary w-25">Tambah</a>
        </div>
      </div>
    </div>
  </div>
